...
TSX17.prototype.waitResult = function(callback) {
	...
	function waitData() {
		...
		console.log("Set timeout RECEIVED now=" + Date.now() + " timeoutId=", timeoutId);
	...
	timeoutId = setTimeout(function() {
		...
		console.log("Set timeout ERROR now=" + Date.now() + " timeoutId=", timeoutId);
	...
	console.log("Set timeout now=" + Date.now() + " timeoutId=", timeoutId);
